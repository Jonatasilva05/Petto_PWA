...
export interface SpeciesEncyclopedia {
  species_value: 'cachorro' | 'gato' | 'coelho' | 'passaro' | 'roedor' | 'reptil' | 'peixe' | 'tartaruga' | 'furao' | 'outro';
    ...
    vaccines: [
      {
        ...
        esquema: {
          ...
          reforco: 'Uma vez por ano, durante toda a vida do animal.',
      ...
      },
      {
        ...
        esquema: {
          ...
          reforco: 'Todo ano, sem exceção. É obrigatória por lei.',
      ...
      },
      {
        ...
        esquema: {
          primario: 'Uma ou duas doses, dependendo do tipo do produto (oral ou injetável).',
    ...
    medications: [
      {
        ...
        regra: {
          quando_usar: 'De rotina, mesmo que o cão pareça saudável — muitos vermes não causam sintomas visíveis.',
      ...
      },
      {
        ...
        regra: {
          quando_usar: 'O ano todo, independente da estação. No verão e período chuvoso o risco aumenta muito.',
          intervalo: 'Depende do produto: comprimidos mensais, pipetas mensais ou coleiras que duram até 8 meses.',
    ...
    vaccines: [
      ...
      },
      {
        ...
        esquema: {
          ...
          reforco: 'Anual, obrigatório por lei.',
        },
        regra: {
    ...
    medications: [
      {
        ...
        regra: {
          quando_usar: 'De rotina, a cada 3 meses para adultos. Filhotes: a cada 15 a 30 dias até os 6 meses.',
          ...
          observacoes: 'O Toxoplasma gondii, um parasita transmitido por gatos, pode ser perigoso para gestantes humanas. Manter o gato vermifugado é uma medida de proteção para toda a família.'
        }
      },
      {
        id: 'antipulgas_carrapatos_cao_gato',
        ...
        regra: {
          ...
          intervalo: 'Mensal ou trimestral, dependendo do produto.',
      ...
      },
      {
        ...
        regra: {
          ...
          intervalo: '2 a 3 vezes por semana, ou conforme orientação veterinária.',
    ...
    medications: [
      {
        ...
        regra: {
          quando_usar: 'Preventivamente em todo coelho novo trazido para casa, e periodicamente conforme orientação veterinária.',
  ...
  // ===================================================
  {
    ...
    vaccines: [
      {
        ...
        esquema: {
          primario: 'Nas primeiras semanas de vida, em gotas na água ou spray.',
    ...
    medications: [
      ...
      },
      {
        ...
        regra: {
          quando_usar: 'Especialmente em aves alimentadas apenas com sementes (dieta incompleta).',
    ...
    medications: [
      {
        ...
        regra: {
          quando_usar: 'Todo dia, especialmente para porquinhos-da-índia — eles não produzem vitamina C naturalmente e morrem sem ela.',
          intervalo: 'Diário, em gotas na água ou em alimentos ricos em vitamina C como pimentão, laranja e salsinha.',
          observacoes: 'Hamsters e gerbils não precisam de suplementação de vitamina C. Mas cobaias (porquinhos-da-índia) precisam dela todo dia. Sinais de deficiência: fraqueza, gengivas sangrando, recusa em se mover.'
        }
      },
      {
        id: 'vermifugo_roedor',
    ...
    medications: [
      {
        ...
        regra: {
          quando_usar: 'Mensalmente, o ano todo.',
