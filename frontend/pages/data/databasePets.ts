...
export const PET_DATA: Species[] = [
  {
    ...
    breeds: [
      ...
      { value: 'collie_pelagem_longa', label: 'Collie (Pelagem Longa)' },
      ...
      { value: 'mini_aussie', label: 'Mini Aussie (Pastor Australiano Miniatura)' },
  ...
  },
  {
    ...
    breeds: [
      ...
      { value: 'russian_blue', label: 'Russian Blue (Azul Russo)' },
  ...
  },
  {
    ...
    breeds: [
      ...
      { value: 'periquito_australiano', label: 'Periquito Australiano (Budgerigar)' },
  ...
  },
  {
    ...
    breeds: [
      ...
      { value: 'beta', label: 'Beta (Peixe de Briga)' },
      ...
      { value: 'xipho', label: 'Xipho (Espada)' },
    ],
  },
  {
    value: 'reptil',
  ...
  },
  {
    ...
    breeds: [
      ...
      { value: 'sulcata', label: 'Tartaruga Sulcata (Africana de Esporas)' },
